 ...
 * @description A prominent section designed to prompt the user to take the next
 * step (e.g., start building a resume). It is purely presentational and uses
 * distinctive styling to stand out on the page.
 */
const CallToAction = () => {
  return (
    // Outer Container: Sets max-width, centers the element, and defines horizontal
    // dashed borders to frame the main content.
    <div
      id="cta"
      className="border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-16 mt-28"
    >
      {/* Inner Content Block: Contains the message and the button. */}
